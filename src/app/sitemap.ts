...
import { db } from "@/db";
import { articles, categories, topics } from "@/db/schema";
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  try {
    const [allCategories, allTopics, publishedArticles] = await Promise.all([
    ...
    console.log("Sitemap articles:", publishedArticles.length);
  } catch (err) {
